...
async def test_whatsapp_service():
    """Test the WhatsApp service with a test message."""
    service = get_whatsapp_service()
    
    if not service.enabled:
        print("WhatsApp service is not enabled. Set WHATSAPP_ENABLED=true in .env")
        return
    
    test_number = input("Enter test phone number (with country code, e.g., +60123456789): ")
    test_message = "Test message from SYB Zone Monitor. If you received this, WhatsApp integration is working! 🎉"
